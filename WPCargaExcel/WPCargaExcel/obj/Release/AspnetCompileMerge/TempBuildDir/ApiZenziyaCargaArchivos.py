...
def GuardarArchivo():
    try:
        ...
        except Exception as exx:   return jsonify(mensaje = 'Error al consultar el api: ' + exx) #print(exx)
        ...
        try:
            ...
            if counter == 0:
                blob_client.upload_blob(files.read())
                return jsonify(mensaje = 'Archivo almacenado')
        except Exception as aa: return jsonify(mensaje = 'Ya existe un archivo con este nombre: ' + aa)

    except Exception as ex:
        return jsonify(mensaje = 'Ya existe un archivo con este nombre: ' + ex)
    else:
        return jsonify(mensaje = 'Archivo almacenado')
